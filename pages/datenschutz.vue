    ...
    >
      ...
      <div class="comp-width">
        <p>
          ...
          Geschäftsleitung von M.Sc.Psych. Simone Ebner. Eine Nutzung der
          Internetseiten von M.Sc.Psych. Simone Ebner ist grundsätzlich
        ...
        <br />
        <p>
          Die Datenschutzerklärung von M.Sc.Psych. Simone Ebner beruht
        ...
        <p>M. Sc. Psych. Simone Ebner</p>
        <p>Paulinstr. 75</p>
        <p>54292 Trier</p>
        <p>Deutschland</p>
        <p>Tel.: 01704743684</p>
        <p>E-Mail: simoneebner@posteo.de</p>
        <p>Website: www.simoneebner.de</p>
        <br />
        ...
        <br />
        <p>
          Die Internetseite von M.Sc.Psych. Simone Ebner erfasst mit
        ...
        <br />
        <p>
          Die Internetseite von M.Sc.Psych. Simone Ebner enthält aufgrund
        ...
        <ul style="list-style: none;">
          ...
          <li>
            ...
            <p>
              ...
              bei von M.Sc.Psych. Simone Ebner gespeichert sind,
              ...
              Mitarbeiter von M.Sc.Psych. Simone Ebner wird veranlassen,
          ...
          <li>
            ...
            <p>
              ...
              Daten, die bei von M.Sc.Psych. Simone Ebner gespeichert
              sind, verlangen möchte, kann sie sich hierzu jederzeit an einen
              Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. Der
              Mitarbeiter von M.Sc.Psych. Simone Ebner wird die
...
export default {
  ...
  head() {
    return {
      title: "Simone Ebner Psychologische Praxis: Datenschutz"
    };
  },
  data() {
    return {};
